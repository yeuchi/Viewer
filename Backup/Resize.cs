...
namespace Viewer
{
	...
	public class Resize : System.Windows.Forms.Form
	{
		...
		{	
			...
			Graphics g = Graphics.FromImage(m_Nbmp);
			Rectangle rectSrc = new Rectangle(0,0, Obmp.Width, Obmp.Height);
			Rectangle rectDst = new Rectangle(0,0, m_Nbmp.Width, m_Nbmp.Height);
			g.DrawImage(Obmp, rectDst, rectSrc, GraphicsUnit.Pixel);
